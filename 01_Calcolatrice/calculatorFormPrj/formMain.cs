...
namespace calculatorFormPrj
{
    public partial class formMain : Form
    {
        ...
        private ButtonStruct[,] buttons =
        {
            ...
            {new ButtonStruct('g',false,false,false,false,false,false,true),new ButtonStruct('c',false),new ButtonStruct('r',false),new ButtonStruct('/',false,false,false,false,true)},
